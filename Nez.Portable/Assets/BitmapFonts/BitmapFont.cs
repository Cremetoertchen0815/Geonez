...
public partial class BitmapFont : IDisposable, IFont
{
    ...
    /// </returns>
    /// <remarks>
    ///     The MeasureString method uses the <paramref name="maxWidth" /> parameter to automatically wrap when
    ...
    public BitmapFontEnumerator GetGlyphs(ref FontCharacterSource text)
    {
        return new BitmapFontEnumerator(this, ref text);
    }
    ...
    ///     outline, 3 if it's set to zero, and 4 if it's set to one.
    /// </remarks>
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether the monochrome charaters have been packed into each of the texture
    ///     channels.
    /// </summary>
    /// <remarks>
