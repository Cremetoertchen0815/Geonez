	...
	public partial class BitmapFont
	{
		...
		public void LoadText(TextReader reader)
		{
			...
			do
			{
				...
				if (line != null)
				{
					string[] parts = BitmapFontLoader.Split(line, ' ');
					if (parts.Length != 0)
					{
						switch (parts[0])
						{
							...
							case "common":
								...
								break;
							case "page":
								int id = BitmapFontLoader.GetNamedInt(parts, "id");
								string name = BitmapFontLoader.GetNamedString(parts, "file");
		...
		private void LoadTextures(bool premultiplyAlpha)
		{
