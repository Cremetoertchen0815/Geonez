...
namespace Nez
{
	public static class Physics
	{
		...
		/// </summary>
		private static RaycastHit[] _hitArray = new RaycastHit[1];
		...
		internal static void DebugDraw(float secondsToDisplay) => _spatialHash.DebugDraw(secondsToDisplay, 2f);
		...
		public static IEnumerable<Collider> GetAllColliders() => _spatialHash.GetAllObjects();
		...
		/// <param name="collider">Collider.</param>
		public static void RemoveCollider(Collider collider) => _spatialHash.Remove(collider);
		...
		/// <param name="layerMask">Layer mask.</param>
		public static Collider OverlapRectangle(RectangleF rect, int layerMask = AllLayers) => OverlapRectangle(ref rect, layerMask);
		...
		/// <param name="layerMask">Layer mask.</param>
		public static HashSet<Collider> BoxcastBroadphase(RectangleF rect, int layerMask = AllLayers) => _spatialHash.AabbBroadphase(ref rect, null, layerMask);
		...
		/// <param name="bounds">Bounds.</param>
		/// <param name="layerMask">Layer mask.</param>
		public static HashSet<Collider> BoxcastBroadphase(ref RectangleF rect, int layerMask = AllLayers) => _spatialHash.AabbBroadphase(ref rect, null, layerMask);
		...
		public static HashSet<Collider> BoxcastBroadphaseExcludingSelf(
			Collider collider, ref RectangleF rect, int layerMask = AllLayers) => _spatialHash.AabbBroadphase(ref rect, collider, layerMask);
