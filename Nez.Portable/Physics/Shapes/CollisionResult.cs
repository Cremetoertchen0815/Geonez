...
namespace Nez
{
	public struct CollisionResult
	{
		...
		public void RemoveHorizontalTranslation(Vector2 deltaMovement)
		{
			...
			{
				float responseDistance = MinimumTranslationVector.Length();
				float fix = responseDistance / Normal.Y;
		...
		public override string ToString() => string.Format("[CollisionResult] normal: {0}, minimumTranslationVector: {1}", Normal,
