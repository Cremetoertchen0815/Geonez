...
namespace Nez.PhysicsShapes
{
	public static partial class ShapeCollisions
	{
		...
		public static bool LineToCircle(Vector2 start, Vector2 end, Circle s, out RaycastHit hit)
		{
			...
			float c = Vector2.Dot(m, m) - s.Radius * s.Radius;
