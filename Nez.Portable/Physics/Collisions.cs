...
namespace Nez
{
	public static class Collisions
	{
		...
		public static bool CircleToCircle(Vector2 circleCenter1, float circleRadius1, Vector2 circleCenter2,
										  float circleRadius2) => Vector2.DistanceSquared(circleCenter1, circleCenter2) <
				   (circleRadius1 + circleRadius2) * (circleRadius1 + circleRadius2);


		public static bool CircleToLine(Vector2 circleCenter, float radius, Vector2 lineFrom, Vector2 lineTo) => Vector2.DistanceSquared(circleCenter, ClosestPointOnLine(lineFrom, lineTo, circleCenter)) <
				   radius * radius;


		public static bool CircleToPoint(Vector2 circleCenter, float radius, Vector2 point) => Vector2.DistanceSquared(circleCenter, point) < radius * radius;
		...
		public static bool RectToCircle(RectangleF rect, Vector2 cPosition, float cRadius) => RectToCircle(rect.X, rect.Y, rect.Width, rect.Height, cPosition, cRadius);


		public static bool RectToCircle(ref RectangleF rect, Vector2 cPosition, float cRadius) => RectToCircle(rect.X, rect.Y, rect.Width, rect.Height, cPosition, cRadius);
		...
		public static bool RectToLine(ref RectangleF rect, Vector2 lineFrom, Vector2 lineTo) => RectToLine(rect.X, rect.Y, rect.Width, rect.Height, lineFrom, lineTo);


		public static bool RectToLine(RectangleF rect, Vector2 lineFrom, Vector2 lineTo) => RectToLine(rect.X, rect.Y, rect.Width, rect.Height, lineFrom, lineTo);
		...
		public static bool RectToPoint(float rX, float rY, float rW, float rH, Vector2 point) => point.X >= rX && point.Y >= rY && point.X < rX + rW && point.Y < rY + rH;


		public static bool RectToPoint(RectangleF rect, Vector2 point) => RectToPoint(rect.X, rect.Y, rect.Width, rect.Height, point);
