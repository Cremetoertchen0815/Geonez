...
namespace Nez.Verlet
{
	...
	public class Composite
	{
		...
		private FastList<Constraint> _constraints = new FastList<Constraint>();
		...
		/// </summary>
		/// <param name="constraint">Constraint.</param>
		public void RemoveConstraint(Constraint constraint) => _constraints.Remove(constraint);
		...
		public void SolveConstraints()
		{
			...
			for (int i = _constraints.Length - 1; i >= 0; i--)
