...
namespace Nez.Tweens
{
	public class TweenManager : GlobalManager
	{
		...
		/// </summary>
		private FastList<ITweenable> _activeTweens = new FastList<ITweenable>();
		public static IReadOnlyList<ITweenable> ActiveTweens => _instance._activeTweens.Buffer;

		/// <summary>
		/// stores tweens marked for removal
		/// </summary>
		private FastList<ITweenable> _tempTweens = new FastList<ITweenable>();
		...
		public override void Update()
		{
			...
			for (int i = 0; i < _tempTweens.Length; i++)
			{
		...
		public static void AddTween(ITweenable tween) => _instance._activeTweens.Add(tween);
		...
		{
			for (int i = _instance._activeTweens.Length - 1; i >= 0; --i)
		...
		public static List<ITweenable> AllTweensWithContext(object context)
		{
			...
			for (int i = 0; i < _instance._activeTweens.Length; i++)
			{
