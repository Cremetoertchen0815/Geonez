...
namespace Nez
{
	public static class TweenExt
	{
		...
		/// <param name="to">To.</param>
		/// <param name="duration">Duration.</param>
		public static ITween<Vector2> TweenScaleTo(this Transform self, float to, float duration = 0.3f) => self.TweenScaleTo(new Vector2(to), duration);
		...
		/// <param name="to">To.</param>
		/// <param name="duration">Duration.</param>
		public static ITween<Vector2> TweenLocalScaleTo(this Transform self, float to, float duration = 0.3f) => self.TweenLocalScaleTo(new Vector2(to), duration);
		...
		/// <param name="to">To.</param>
		/// <param name="duration">Duration.</param>
		public static ITween<Vector2> TweenScaleTo(this Entity self, float to, float duration = 0.3f) => self.TweenScaleTo(new Vector2(to), duration);
		...
		/// <param name="to">To.</param>
		/// <param name="duration">Duration.</param>
		public static ITween<Vector2> TweenLocalScaleTo(this Entity self, float to, float duration = 0.3f) => self.TweenLocalScaleTo(new Vector2(to), duration);
