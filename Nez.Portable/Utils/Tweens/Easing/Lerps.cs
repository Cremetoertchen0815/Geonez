...
namespace Nez.Tweens
{
	...
	public static class Lerps
	{
		...
		public static float LerpTowards(float from, float to, float remainingFactorPerSecond, float deltaTime) => Lerp(from, to, 1f - Mathf.Pow(remainingFactorPerSecond, deltaTime));
		...
		public static float LerpDamp(float source, float target, float smoothing) => MathHelper.Lerp(source, target, 1 - Mathf.Pow(smoothing, Time.DeltaTime));


		public static Vector2 Lerp(Vector2 from, Vector2 to, float t) => new Vector2(from.X + (to.X - from.X) * t, from.Y + (to.Y - from.Y) * t);


		// remainingFactorPerSecond is the percentage of the distance it covers every second. should be between 0 and 1.
		// if it's 0.25 it means it covers 75% of the remaining distance every second independent of the framerate
		public static Vector2 LerpTowards(Vector2 from, Vector2 to, float remainingFactorPerSecond, float deltaTime) => Lerp(from, to, 1f - Mathf.Pow(remainingFactorPerSecond, deltaTime));


		public static Vector3 Lerp(Vector3 from, Vector3 to, float t) => new Vector3(from.X + (to.X - from.X) * t, from.Y + (to.Y - from.Y) * t,
				from.Z + (to.Z - from.Z) * t);


		// remainingFactorPerSecond is the percentage of the distance it covers every second. should be between 0 and 1.
		// if it's 0.25 it means it covers 75% of the remaining distance every second independent of the framerate
		public static Vector3 LerpTowards(Vector3 from, Vector3 to, float remainingFactorPerSecond, float deltaTime) => Lerp(from, to, 1f - Mathf.Pow(remainingFactorPerSecond, deltaTime));
		...
		public static Vector4 Lerp(Vector4 from, Vector4 to, float t) => new Vector4(from.X + (to.X - from.X) * t, from.Y + (to.Y - from.Y) * t, from.Z + (to.Z - from.Z) * t,
		...
		public static Rectangle Lerp(Rectangle from, Rectangle to, float t) => new Rectangle
			(
		...
		public static Rectangle Lerp(ref Rectangle from, ref Rectangle to, float t) => new Rectangle
			(
				(int)(from.X + (to.X - from.X) * t),
				(int)(from.Y + (to.Y - from.Y) * t),
				(int)(from.Width + (to.Width - from.Width) * t),
		...
		public static float Ease(EaseType easeType, float from, float to, float t, float duration) => Lerp(from, to, EaseHelper.Ease(easeType, t, duration));


		public static Vector2 Ease(EaseType easeType, Vector2 from, Vector2 to, float t, float duration) => Lerp(from, to, EaseHelper.Ease(easeType, t, duration));


		public static Vector3 Ease(EaseType easeType, Vector3 from, Vector3 to, float t, float duration) => Lerp(from, to, EaseHelper.Ease(easeType, t, duration));


		public static Vector2 EaseAngle(EaseType easeType, Vector2 from, Vector2 to, float t, float duration) => AngleLerp(from, to, EaseHelper.Ease(easeType, t, duration));


		public static Vector4 Ease(EaseType easeType, Vector4 from, Vector4 to, float t, float duration) => Lerp(from, to, EaseHelper.Ease(easeType, t, duration));


		public static Quaternion Ease(EaseType easeType, Quaternion from, Quaternion to, float t, float duration) => Quaternion.Lerp(from, to, EaseHelper.Ease(easeType, t, duration));


		public static Color Ease(EaseType easeType, Color from, Color to, float t, float duration) => Lerp(from, to, EaseHelper.Ease(easeType, t, duration));


		public static Color Ease(EaseType easeType, ref Color from, ref Color to, float t, float duration) => Lerp(ref from, ref to, EaseHelper.Ease(easeType, t, duration));


		public static Rectangle Ease(EaseType easeType, Rectangle from, Rectangle to, float t, float duration) => Lerp(from, to, EaseHelper.Ease(easeType, t, duration));


		public static Rectangle Ease(EaseType easeType, ref Rectangle from, ref Rectangle to, float t, float duration) => Lerp(ref from, ref to, EaseHelper.Ease(easeType, t, duration));
