...
namespace Nez.Tweens
{
	...
	public abstract class Tween<T> : ITweenable, ITween<T> where T : struct
	{
		...
		public bool IsRunning() => _tweenState == TweenState.Running;
		...
		public void Pause() => _tweenState = TweenState.Paused;


		public void Resume() => _tweenState = TweenState.Running;
		...
		/// </summary>
		public void ReverseTween() => _isRunningInReverse = !_isRunningInReverse;
		...
		public object GetTargetObject() => _target.GetTargetObject();
