...
namespace Nez
{
	...
	public class NezSpriteFont : IFont
	{
		...
		/// <param name="c">C.</param>
		public bool HasCharacter(char c) => TryGetFontRegionForChar(c, out var fontGlyph);
							 ...
							 float rotation, Vector2 origin, Vector2 scale, SpriteEffects effect, float depth)
		{
			...
			bool requiresTransformation = flippedHorz || flippedVert || rotation != 0f || scale != Vector2.One;
