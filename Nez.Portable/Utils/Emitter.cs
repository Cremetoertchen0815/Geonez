...
namespace Nez.Systems
{
	...
	{
		private Dictionary<T, List<Action>> _messageTable;


		public Emitter() => _messageTable = new Dictionary<T, List<Action>>();
		...
		public Emitter(IEqualityComparer<T> customComparer) => _messageTable = new Dictionary<T, List<Action>>(customComparer);
	...
	{
		private Dictionary<T, List<Action<U>>> _messageTable;


		public Emitter() => _messageTable = new Dictionary<T, List<Action<U>>>();
		...
		/// </summary>
		/// <param name="customComparer">Custom comparer.</param>
		public Emitter(IEqualityComparer<T> customComparer) => _messageTable = new Dictionary<T, List<Action<U>>>(customComparer);
