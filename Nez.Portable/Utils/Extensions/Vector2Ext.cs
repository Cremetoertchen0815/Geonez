...
namespace Nez
{
	public static class Vector2Ext
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Vector2 Floor(Vector2 val) => new Vector2((int)val.X, (int)val.Y);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Vector2 HalfVector() => new Vector2(0.5f, 0.5f);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Vector2 Perpendicular(ref Vector2 first, ref Vector2 second) => new Vector2(-1f * (second.Y - first.Y), second.X - first.X);
		...
		/// <param name="second">Second.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Vector2 Perpendicular(Vector2 first, Vector2 second) => new Vector2(-1f * (second.Y - first.Y), second.X - first.X);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Vector2 Perpendicular(Vector2 original) => new Vector2(-original.Y, original.X);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Vector2 Transform(Vector2 position, Matrix2D matrix) => new Vector2((position.X * matrix.M11) + (position.Y * matrix.M21) + matrix.M31,
		...
		/// <param name="destinationArray">Destination array.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void Transform(Vector2[] sourceArray, ref Matrix2D matrix, Vector2[] destinationArray) => Transform(sourceArray, 0, ref matrix, destinationArray, 0, sourceArray.Length);
	}
}