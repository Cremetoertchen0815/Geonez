...
public static class SpriteBatchExt
{
    ...
    public static void DrawHollowRect(this SpriteBatch spriteBatch, Rectangle rect, Color color, int thickness = 1)
    {
        DrawHollowRect(spriteBatch, rect.X, rect.Y, rect.Width, rect.Height, color, thickness);
    }


    public static void DrawHollowRect(this SpriteBatch spriteBatch, RectangleF rect, Color color, int thickness = 1)
    {
        DrawHollowRect(spriteBatch, rect.X, rect.Y, rect.Width, rect.Height, color, thickness);
    }
    ...
    public static void DrawOutline(this SpriteBatch spriteBatch, Vector2 position, float width, float height,
        Color color, int thickness = 1)
    {
        DrawOutline(spriteBatch, position.X, position.Y, width, height, color, thickness);
    }


    public static void DrawOutline(this SpriteBatch spriteBatch, Rectangle rect, Color color, int thickness = 1)
    {
        DrawOutline(spriteBatch, rect.X, rect.Y, rect.Width, rect.Height, color, thickness);
    }


    public static void DrawOutline(this SpriteBatch spriteBatch, RectangleF rect, Color color, int thickness = 1)
    {
        DrawOutline(spriteBatch, rect.X, rect.Y, rect.Width, rect.Height, color, thickness);
    }
