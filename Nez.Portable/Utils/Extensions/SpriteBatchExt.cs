...
namespace Nez
{
	public static class SpriteBatchExt
	{
		...
		public static void DrawLine(this SpriteBatch spriteBatch, Vector2 start, Vector2 end, Color color) => DrawLineAngle(spriteBatch, start, Mathf.AngleBetweenVectors(start, end), Vector2.Distance(start, end),
				color);


		public static void DrawLine(this SpriteBatch spriteBatch, Vector2 start, Vector2 end, Color color,
									float thickness) => DrawLineAngle(spriteBatch, start, Mathf.AngleBetweenVectors(start, end), Vector2.Distance(start, end),
				color, thickness);


		public static void DrawLine(this SpriteBatch spriteBatch, float x1, float y1, float x2, float y2, Color color) => DrawLine(spriteBatch, new Vector2(x1, y1), new Vector2(x2, y2), color);
		...
		public static void DrawLineAngle(this SpriteBatch spriteBatch, Vector2 start, float angle, float length,
										 Color color) => spriteBatch.Draw(Graphics.Instance.PixelTexture, start, Graphics.Instance.PixelTexture.SourceRect, color,
				angle, Vector2.Zero, new Vector2(length, 1), SpriteEffects.None, 0);


		public static void DrawLineAngle(this SpriteBatch spriteBatch, Vector2 start, float angle, float length,
										 Color color, float thickness) => spriteBatch.Draw(Graphics.Instance.PixelTexture, start, Graphics.Instance.PixelTexture.SourceRect, color,
		...
		public static void DrawLineAngle(this SpriteBatch spriteBatch, float startX, float startY, float angle,
										 float length, Color color) => DrawLineAngle(spriteBatch, new Vector2(startX, startY), angle, length, color);
		...
		public static void DrawCircle(this SpriteBatch spriteBatch, float x, float y, float radius, Color color,
									  int resolution) => DrawCircle(spriteBatch, new Vector2(x, y), radius, color, resolution);
		...
		public static void DrawRect(this SpriteBatch spriteBatch, Vector2 position, float width, float height,
									Color color) => DrawRect(spriteBatch, position.X, position.Y, width, height, color);
		...
		public static void DrawPixel(this SpriteBatch spriteBatch, float x, float y, Color color) => DrawPixel(spriteBatch, new Vector2(x, y), color);
