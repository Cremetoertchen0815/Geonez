...
namespace Nez
{
	public static class ColorExt
	{
		...
		public static string ToRGBAHex(this Color c) => $"#{c.PackedValue.FlipByteSex():X8}";
		public static Color FromRGBAHex(this string c) => new Color(uint.Parse(c.AsSpan().Slice(1), System.Globalization.NumberStyles.HexNumber).FlipByteSex());
