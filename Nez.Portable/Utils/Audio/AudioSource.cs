...
namespace Nez.Audio
{
	...
	public class AudioSource
	{
		...
		public void Play(float volume, float pitch, float pan = 0) => _soundEffects.RandomItem().Play(volume, pitch, pan);


		public SoundEffectInstance CreateInstance() => _soundEffects.RandomItem().CreateInstance();
	}
}