...
namespace System.Collections.Generic
{
	...
	public class Deque<T> : IList<T>
	{
		...
		public Deque(IEnumerable<T> collection) : this(collection.Count()) => InsertRange(0, collection);
		...
		public int Capacity
		{
			...
			set
			{
				...
				int powOfTwo = Mathf.ClosestPowerOfTwoGreaterThan(value);
		...
		private int PostShiftStartOffset(int value) => ShiftStartOffset(value);
		...
		private void IncrementCount(int value) => Count = Count + value;
		...
		public void AddRange(IEnumerable<T> collection) => AddBackRange(collection);

		/// <summary>
		/// Adds a collection of items to the front of the Deque.
		/// </summary>
		/// <param name="collection">The collection to add.</param>
		public void AddFrontRange(IEnumerable<T> collection) => AddFrontRange(collection, 0, collection.Count());
		...
		/// </param>
		public void AddFrontRange(IEnumerable<T> collection, int fromIndex, int count) => InsertRange(0, collection, fromIndex, count);

		/// <summary>
		/// Adds a collection of items to the back of the Deque.
		/// </summary>
		/// <param name="collection">The collection to add.</param>
		public void AddBackRange(IEnumerable<T> collection) => AddBackRange(collection, 0, collection.Count());
		...
		/// The number of items in the collection to add.
		/// </param>
		public void AddBackRange(IEnumerable<T> collection, int fromIndex, int count) => InsertRange(Count, collection, fromIndex, count);
