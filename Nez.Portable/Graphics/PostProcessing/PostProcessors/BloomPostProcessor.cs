...
namespace Nez
{
	public class QualityBloomPostProcessor : PostProcessor, IDisposable
	{
		...
		//Objects
		private GraphicsDevice _graphicsDev;
		...
		public override void OnSceneBackBufferSizeChanged(int newWidth, int newHeight) => UpdateResolution(newWidth, newHeight);
		...
		private void ChangeBlendState() => _graphicsDev.BlendState = BlendState.AlphaBlend;
