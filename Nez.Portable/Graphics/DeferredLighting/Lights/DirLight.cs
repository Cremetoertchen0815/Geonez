...
namespace Nez.DeferredLighting
{
	...
	public class DirLight : DeferredLight
	{
		...
		public DirLight() => _bounds = RectangleF.MaxRect;


		public DirLight(Color color) : this() => Color = color;


		public DirLight(Color color, Vector3 lightDirection) : this(color) => Direction = lightDirection;
		...
		public override void DebugRender(Batcher batcher)
		{
			...
			if (Direction.Y > 0)
				...
				root.Y = Screen.BackbufferHeight - 10;

			if (Direction.X > 0)
				root.X = 10;
			else
				root.X = Screen.BackbufferWidth - 10;
