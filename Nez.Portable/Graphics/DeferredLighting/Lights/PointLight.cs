...
namespace Nez.DeferredLighting
{
	...
	public class PointLight : DeferredLight
	{
		public override RectangleF Bounds
		{
			get
			{
				if (_areBoundsDirty)
				{
					...
					float size = Radius * Entity.Transform.Scale.X * 2;
		...
		public PointLight() => SetRadius(400f);


		public PointLight(Color color) : this() => Color = color;
		...
		public override void DebugRender(Batcher batcher) => batcher.DrawCircle(Entity.Transform.Position + _localOffset, Radius * Entity.Transform.Scale.X, Color.DarkOrchid, 2);
	}
}