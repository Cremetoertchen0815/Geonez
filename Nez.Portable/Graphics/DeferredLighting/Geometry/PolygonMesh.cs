...
namespace Nez.DeferredLighting
{
	...
	public class PolygonMesh : IDisposable
	{
		...
		public static PolygonMesh CreateSymmetricalPolygon(int vertCount, float radius) => new PolygonMesh(PhysicsShapes.Polygon.BuildSymmetricalPolygon(vertCount, radius));
		...
		public PolygonMesh(Vector2[] points)
		{
			...
			short[] indices = new short[points.Length * 3];
