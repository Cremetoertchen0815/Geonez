...
namespace Nez.Textures
{
	...
	public class RenderTexture : IDisposable
	{
		...
		/// </summary>
		public RenderTexture() => RenderTarget = Textures.RenderTarget.Create(Screen.BackbufferWidth, Screen.BackbufferHeight, Screen.BackBufferFormat,
		...
		public RenderTexture(DepthFormat preferredDepthFormat) => RenderTarget = Textures.RenderTarget.Create(Screen.BackbufferWidth, Screen.BackbufferHeight, Screen.BackBufferFormat,
		...
		public RenderTexture(int width, int height) => RenderTarget = Textures.RenderTarget.Create(width, height, Screen.BackBufferFormat,
				Screen.PreferredDepthStencilFormat);
		...
		/// <param name="height">Height.</param>
		/// <param name="preferredDepthFormat">Preferred depth format.</param>
		public RenderTexture(int width, int height, DepthFormat preferredDepthFormat) => RenderTarget = Textures.RenderTarget.Create(width, height, Screen.BackBufferFormat, preferredDepthFormat);
		...
		/// <param name="preferredDepthFormat">Preferred depth format.</param>
		public RenderTexture(int width, int height, SurfaceFormat preferredFormat, DepthFormat preferredDepthFormat) => RenderTarget = new RenderTarget2D(Core.GraphicsDevice, width, height, false, preferredFormat,
		...
		/// </summary>
		public void ResizeToFitBackbuffer() => Resize(Screen.BackbufferWidth, Screen.BackbufferHeight);
