...
public class Sprite
{
    ...
    ///     To just get the source rects for rendering pass in the Sprite.sourceRect. Pass in a larger Rectangle to get final
    ///     destination
    ...
    public static implicit operator Texture2D(Sprite tex)
    {
