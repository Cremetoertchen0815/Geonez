...
namespace Nez
{
	public class ReflectionEffect : Effect
	{
		...
		private const float _normalMagnitude = 0.05f;
		private EffectParameter _reflectionIntensityParam;
		private EffectParameter _renderTextureParam;
		private EffectParameter _normalMapParam;
		private EffectParameter _matrixTransformParam;
		private EffectParameter _normalMagnitudeParam;
