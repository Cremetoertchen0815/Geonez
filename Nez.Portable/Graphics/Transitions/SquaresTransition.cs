...
namespace Nez
{
	...
	public class SquaresTransition : SceneTransition
	{
		...
		public SquaresTransition(Func<Scene> sceneLoadAction) : base(sceneLoadAction, true)
		{
			...
			float aspectRatio = Screen.BackbufferWidth / (float)Screen.BackbufferHeight;
		...
		public override void Render(Batcher batcher)
		{
			...
			if (!_isNewSceneLoaded)
				...
				batcher.Draw(_overlayTexture, new Rectangle(0, 0, Screen.BackbufferWidth, Screen.BackbufferHeight), Color.Transparent);
