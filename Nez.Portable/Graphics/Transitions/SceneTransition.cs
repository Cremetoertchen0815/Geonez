...
public abstract class SceneTransition
{
    ...
    ///     fade in. For in-Scene transitions _isNewSceneLoaded should be set to true at the midpoint just as if a new Scene
    ///     was loaded.
    /// </summary>
    ...
    protected SceneTransition(Func<Scene> sceneLoadAction, bool wantsPreviousSceneRender = true)
    {
        ...
        if (wantsPreviousSceneRender)
            PreviousSceneRender = new RenderTarget2D(Core.GraphicsDevice, Screen.BackbufferWidth,
                Screen.BackbufferHeight, false,
    ...
    {
        Core._instance.SceneTransition = null;
