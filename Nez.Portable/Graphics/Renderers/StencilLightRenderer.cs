...
///     - you will then have access to StencilLightRenderer.RenderTexture which will contain your lightmap. You can then
...
public class StencilLightRenderer : Renderer
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void RenderPolygon(Polygon polygon, Vector2 lightPos)
    {
        RenderVerts(polygon.position, lightPos, polygon.Points);
    }
