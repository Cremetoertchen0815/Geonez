...
namespace Nez
{
	...
	public class Material : IComparable<Material>, IDisposable
	{
		...
		public static Material StencilWrite(int stencilRef = 1) => new Material
		{
		...
		public static Material StencilRead(int stencilRef = 1) => new Material
		{
			DepthStencilState = new DepthStencilState
			{
				StencilEnable = true,
		...
		public static Material BlendDarken() => new Material
		{
		...
		public static Material BlendLighten() => new Material
		{
			BlendState = new BlendState
			{
				ColorSourceBlend = Blend.One,
		...
		public static Material BlendScreen() => new Material
		{
			BlendState = new BlendState
			{
		...
		public static Material BlendMultiply() => new Material
		{
			BlendState = new BlendState
			{
		...
		/// </summary>
		public static Material BlendMultiply2x() => new Material
		{
			BlendState = new BlendState
			{
				ColorSourceBlend = Blend.DestinationColor,
		...
		public static Material BlendLinearDodge() => new Material
		{
			BlendState = new BlendState
			{
				ColorSourceBlend = Blend.One,
		...
		public static Material BlendLinearBurn() => new Material
		{
			BlendState = new BlendState
			{
				ColorSourceBlend = Blend.One,
		...
		public static Material BlendDifference() => new Material
		{
			BlendState = new BlendState
			{
				ColorSourceBlend = Blend.InverseDestinationColor,
		...
		public static Material BlendSubtractive() => new Material
		{
			BlendState = new BlendState
			{
		...
		public static Material BlendAdditive() => new Material
		{
			BlendState = new BlendState
			{
				ColorSourceBlend = Blend.SourceAlpha,
		...
		/// </summary>
		public Material Clone() => new Material
		{
			BlendState = BlendState,
			DepthStencilState = DepthStencilState,
