...
namespace Nez.Svg
{
	...
	public abstract class SvgPathSegment
	{
		...
		protected string ToSvgString(Vector2 point) => string.Format("{0} {1}", point.X, point.Y);
	}
	...
	public sealed class SvgMoveToSegment : SvgPathSegment
	{
		...
		public override string ToString() => "M" + ToSvgString(Start);
	}
	...
	public sealed class SvgLineSegment : SvgPathSegment
	{
		...
		public override string ToString() => "L" + ToSvgString(End);
	}
	...
	public sealed class SvgQuadraticCurveSegment : SvgPathSegment
	{
		...
		public override string ToString() => "Q" + ToSvgString(ControlPoint) + " " + ToSvgString(End);
	}
	...
	public sealed class SvgCubicCurveSegment : SvgPathSegment
	{
		...
		public override string ToString() => "C" + ToSvgString(FirstCtrlPoint) + " " + ToSvgString(SecondCtrlPoint) + " " + ToSvgString(End);
	}
}