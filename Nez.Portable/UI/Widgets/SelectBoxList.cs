...
namespace Nez.UI
{
	public class SelectBoxList<T> : ScrollPane where T : class
	{
		...
		public void Show(Stage stage)
		{
			...
			float heightBelow = (Screen.BackbufferHeight / stage.Camera.RawZoom) - _screenPosition.Y - _selectBox.GetHeight();
			...
			float width = Math.Max(PreferredWidth, _selectBox.GetWidth());
