...
namespace Nez.UI
{
	public class Label : Element
	{
		...
		private int labelAlign = AlignInternal.Left;
		...
		public Label SetAlignment(Align alignment) => SetAlignment(alignment, alignment);
		...
		public override void Layout()
		{
			...
			bool isWrapped = _wrapText && _ellipsis == null;
			if (isWrapped)
			{
	...
	public class LabelStyle
	{
		...
		public LabelStyle() => Font = Graphics.Instance.BitmapFont;
		...
		public LabelStyle Clone() => new LabelStyle
		{
			FontColor = FontColor,
			Font = Font,
