...
namespace Nez.UI
{
	...
	public class Tooltip : Element
	{
		...
		public TooltipManager GetManager() => _manager;
		...
		public Element GetElement() => _container.GetElement();


		public T GetElement<T>() where T : Element => _container.GetElement<T>();
		...
		public Element GetTargetElement() => _targetElement;
		...
		public bool GetInstant() => _instant;
