...
namespace Nez.UI
{
	public class TextButton : Button
	{
		...
		public override string ToString() => string.Format("[TextButton] text: {0}", GetText());
	}
	...
	public class TextButtonStyle : ButtonStyle
	{
		...
		public TextButtonStyle() => Font = Graphics.Instance.BitmapFont;


		public TextButtonStyle(IDrawable up, IDrawable down, IDrawable over, BitmapFont font) : base(up, down, over) => Font = font ?? Graphics.Instance.BitmapFont;
		...
		public static new TextButtonStyle Create(Color upColor, Color downColor, Color overColor) => new TextButtonStyle
		{
		...
		public new TextButtonStyle Clone() => new TextButtonStyle
		{
			Up = Up,
			Down = Down,
			Over = Over,
