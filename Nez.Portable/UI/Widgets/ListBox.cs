...
namespace Nez.UI
{
	...
	public class ListBox<T> : Element, IInputListener where T : class
	{
		...
		void IInputListener.OnMouseEnter() => _isMouseOverList = true;
		...
		bool IInputListener.OnMousePressed(Vector2 mousePos)
		{
			...
			int index = GetItemIndexUnderMousePosition(mousePos);
		...
		private int GetItemIndexUnderMousePosition(Vector2 mousePos)
		{
			...
			int index = (int)((top + mousePos.Y) / _itemHeight);
		...
		public float GetItemHeight() => _itemHeight;
	...
	public class ListBoxStyle
	{
		...
		public ListBoxStyle() => Font = Graphics.Instance.BitmapFont;
		...
		public ListBoxStyle Clone() => new ListBoxStyle
		{
			Font = Font,
			FontColorSelected = FontColorSelected,
			FontColorUnselected = FontColorUnselected,
