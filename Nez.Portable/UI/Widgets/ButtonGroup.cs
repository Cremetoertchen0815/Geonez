...
namespace Nez.UI
{
	...
	public class ButtonGroup
	{
		...
		public ButtonGroup() => minCheckCount = 1;
		...
		public List<Button> GetAllChecked() => checkedButtons;
		...
		public void SetMinCheckCount(int minCheckCount) => this.minCheckCount = minCheckCount;
		...
		public void SetUncheckLast(bool uncheckLast) => this.uncheckLast = uncheckLast;
	}
}