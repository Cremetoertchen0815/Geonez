namespace Nez.UI
{
	...
	public class Dialog : Window
	{
		...
		public Dialog(string title, WindowStyle windowStyle) : base(title, windowStyle) => Initialize();
		...
		public Table GetContentTable() => contentTable;


		public Table GetButtonTable() => buttonTable;
		...
		public Dialog AddText(string text) => AddText(new Label(text));
	 ...
	 * @param object The object that will be passed to {@link #result(Object)} if this button is clicked. May be null. */
		public Button AddButton(string text, TextButtonStyle buttonStyle) => AddButton(new TextButton(text, buttonStyle));
