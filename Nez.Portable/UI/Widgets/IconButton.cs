namespace Nez.UI
{
	...
	public class IconButton : Button
	{
		...
		public new IconButtonStyle GetStyle() => style;
	...
	public class IconButtonStyle : ImageButtonStyle
	{
		...
		public IconButtonStyle(IDrawable icon, IDrawable up, IDrawable down, IDrawable checkked, IDrawable imageUp, IDrawable imageDown, IDrawable imageChecked) : base(up, down, checkked, imageUp, imageDown, imageChecked) => Icon = icon;


		public new IconButtonStyle Clone() => new IconButtonStyle
		{
			Icon = Icon,
			Up = Up,
			Down = Down,
