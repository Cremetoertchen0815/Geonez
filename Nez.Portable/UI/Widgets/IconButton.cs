...
public class IconButton : Button
{
    ...
    public IconButton(IDrawable icon, IDrawable imageUp) : this(new IconButtonStyle(icon, null, null, null, imageUp,
        null, null))
    {
    }


    public IconButton(IDrawable icon, IDrawable imageUp, IDrawable imageDown) : this(
        new IconButtonStyle(icon, null, null, null, imageUp, imageDown, null))
    {
    }


    public IconButton(IDrawable icon, IDrawable imageUp, IDrawable imageDown, IDrawable imageOver) : this(
        new IconButtonStyle(icon, null, null, null, imageUp, imageDown, imageOver))
    {
    }
...
public class IconButtonStyle : ImageButtonStyle
{
    ...
    public IconButtonStyle(IDrawable icon, IDrawable up, IDrawable down, IDrawable checkked, IDrawable imageUp,
        IDrawable imageDown, IDrawable imageChecked) : base(up, down, checkked, imageUp, imageDown, imageChecked)
    {
        Icon = icon;
    }
