...
namespace Nez.UI
{
	public class SelectBox<T> : Element, IInputListener where T : class
	{
		...
		private ArraySelection<T> _selection;
		private SelectBoxList<T> _selectBoxList;
		...
		void IInputListener.OnMouseEnter() => _isMouseOver = true;


		void IInputListener.OnMouseExit() => _isMouseOver = false;
		...
		public void SetMaxListCount(int maxListCount) => _selectBoxList.MaxListCount = maxListCount;
		...
		/// </summary>
		/// <returns>The max list count.</returns>
		public int GetMaxListCount() => _selectBoxList.MaxListCount;
		...
		public SelectBoxStyle GetStyle() => style;
		...
		public void SetItems(params T[] newItems) => SetItems(new List<T>(newItems));
		...
		public ListBox<T> GetListBox() => _selectBoxList.ListBox;
	...
	public class SelectBoxStyle
	{
		...
		public SelectBoxStyle() => Font = Graphics.Instance.BitmapFont;
