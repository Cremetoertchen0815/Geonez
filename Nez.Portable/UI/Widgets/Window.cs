...
namespace Nez.UI
{
	...
	public class Window : Table, IInputListener
	{
		...
		private int resizeBorderSize = 8;
		...
		void IInputListener.OnMouseMoved(Vector2 mousePos)
		{
			...
			bool clampPosition = _keepWithinStage && GetParent() == stage.GetRoot();
			...
			if ((edge & AlignInternal.Bottom) != 0)
			{
		...
		void IInputListener.OnMouseUp(Vector2 mousePos) => _dragging = false;
		...
		public WindowStyle GetStyle() => style;
		...
		public float GetPrefWidth() => Math.Max(base.PreferredWidth, titleLabel.PreferredWidth + GetPadLeft() + GetPadRight());
	...
	public class WindowStyle
	{
		...
		public WindowStyle() => TitleFont = Graphics.Instance.BitmapFont;
		...
		public WindowStyle Clone() => new WindowStyle
		{
			Background = Background,
			TitleFont = TitleFont,
			TitleFontColor = TitleFontColor,
