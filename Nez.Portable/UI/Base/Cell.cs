...
namespace Nez.UI
{
	...
	{
		private static int centeri = AlignInternal.Center,
		...
		internal void SetLayout(Table table) => this.table = table;
		...
		public T GetElement<T>() where T : Element => element as T;
		...
		/// </summary>
		/// <param name="size">Size.</param>
		public Cell Size(float size) => Size(new Value.Fixed(size));
		...
		/// <param name="width">Width.</param>
		/// <param name="height">Height.</param>
		public Cell Size(float width, float height) => Size(new Value.Fixed(width), new Value.Fixed(height));
		...
		/// </summary>
		/// <param name="width">Width.</param>
		public Cell Width(float width) => Width(new Value.Fixed(width));
		...
		/// </summary>
		/// <param name="height">Height.</param>
		public Cell Height(float height) => Height(new Value.Fixed(height));
		...
		/// </summary>
		/// <param name="pad">Pad.</param>
		public Cell Pad(float pad) => Pad(new Value.Fixed(pad));
		...
		public float GetElementX() => elementX;


		public void SetElementX(float elementX) => this.elementX = elementX;


		public float GetElementY() => elementY;


		public void SetElementY(float elementY) => this.elementY = elementY;


		public float GetElementWidth() => elementWidth;


		public void SetElementWidth(float elementWidth) => this.elementWidth = elementWidth;


		public float GetElementHeight() => elementHeight;


		public void SetElementHeight(float elementHeight) => this.elementHeight = elementHeight;
		...
		public Value GetMinWidthValue() => minWidth;


		public float GetMinWidth() => minWidth.Get(element);
		...
		public Value GetMinHeightValue() => minHeight;


		public float GetMinHeight() => minHeight.Get(element);
		...
		public Value GetPrefWidthValue() => prefWidth;


		public float GetPrefWidth() => prefWidth.Get(element);
		...
		public Value GetPrefHeightValue() => prefHeight;


		public float GetPrefHeight() => prefHeight.Get(element);
		...
		public Value GetMaxWidthValue() => maxWidth;


		public float GetMaxWidth() => maxWidth.Get(element);
		...
		public Value GetMaxHeightValue() => maxHeight;


		public float GetMaxHeight() => maxHeight.Get(element);
		...
		public Value GetSpaceTopValue() => spaceTop;


		public float GetSpaceTop() => spaceTop.Get(element);
		...
		public Value GetSpaceLeftValue() => spaceLeft;


		public float GetSpaceLeft() => spaceLeft.Get(element);
		...
		public Value GetSpaceBottomValue() => spaceBottom;


		public float GetSpaceBottom() => spaceBottom.Get(element);
		...
		public Value GetSpaceRightValue() => spaceRight;


		public float GetSpaceRight() => spaceRight.Get(element);
		...
		public Value GetPadTopValue() => padTop;


		public float GetPadTop() => padTop.Get(element);
		...
		public Value GetPadLeftValue() => padLeft;


		public float GetPadLeft() => padLeft.Get(element);
		...
		public Value GetPadBottomValue() => padBottom;


		public float GetPadBottom() => padBottom.Get(element);
		...
		public Value GetPadRightValue() => padRight;


		public float GetPadRight() => padRight.Get(element);
		...
		public float GetPadX() => padLeft.Get(element) + padRight.Get(element);
		...
		public float GetPadY() => padTop.Get(element) + padBottom.Get(element);
		...
		public bool? GetUniformX() => uniformX;
		...
		public bool? GetUniformY() => uniformY;
		...
		public float GetComputedPadTop() => computedPadTop;
		...
		public float GetComputedPadLeft() => computedPadLeft;
		...
		public float GetComputedPadBottom() => computedPadBottom;
		...
		public float GetComputedPadRight() => computedPadRight;
		...
		public override string ToString() => element != null ? element.ToString() : base.ToString();
	}
}