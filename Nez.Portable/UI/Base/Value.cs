namespace Nez.UI
{
	...
	public abstract class Value
	{
		...
		public class Fixed : Value
		{
			...
			public Fixed(float value) => this.value = value;

			public override float Get(Element context) => value;
		}
		...
		/// Value that is the maxHeight of the element in the cell.
		/// </summary>
		public static Value PercentWidth(float percent) => new PercentWidthValue()
		{
			Percent = percent
		};
		...
		public class PercentWidthValue : Value
		{
			...
			public override float Get(Element element) => element.width * Percent;
		}
		...
		/// </summary>
		public static Value PercentWidth(float percent, Element delegateElement) => new PercentWidthDelegateValue()
		{
		...
		public class PercentWidthDelegateValue : Value
		{
			...
			public override float Get(Element element) => DelegateElement.width * Percent;
		}
		...
		/// </summary>
		public static Value PercentHeight(float percent) => new PercentageHeightValue()
		{
			Percent = percent
		};
		...
		public class PercentageHeightValue : Value
		{
			...
			public override float Get(Element element) => element.height * Percent;
		}
		...
		/// </summary>
		public static Value PercentHeight(float percent, Element delegateElement) => new PercentHeightDelegateValue()
		{
			DelegateElement = delegateElement,
			Percent = percent
		};
		...
		public class PercentHeightDelegateValue : Value
		{
			...
			public override float Get(Element element) => DelegateElement.height * Percent;
		}
	}
}