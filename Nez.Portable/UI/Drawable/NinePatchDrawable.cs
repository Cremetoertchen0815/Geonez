...
namespace Nez.UI
{
	...
	public class NinePatchDrawable : IDrawable
	{
		...
		private Rectangle[] _destRects = new Rectangle[9];
		private NinePatchSprite _sprite;
		...
		public NinePatchDrawable NewTintedDrawable(Color tint) => new NinePatchDrawable(_sprite)
		{
			LeftWidth = LeftWidth,
