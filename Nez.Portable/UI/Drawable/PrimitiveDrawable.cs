...
namespace Nez.UI
{
	public class PrimitiveDrawable : IDrawable
	{
		...
		public PrimitiveDrawable(Color? color = null) => Color = color;


		public PrimitiveDrawable(Color color, float horizontalPadding) : this(color) => LeftWidth = RightWidth = horizontalPadding;
