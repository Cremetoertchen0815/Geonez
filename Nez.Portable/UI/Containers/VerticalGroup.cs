...
namespace Nez.UI
{
	...
	public class VerticalGroup : Group
	{
		...
		public VerticalGroup(float spacing) : this() => SetSpacing(spacing);
		...
		{
			float groupWidth = width - _padLeft - _padRight;
			float y = _reverse ? height - _padBottom + _spacing : _padTop;
