...
namespace Nez.UI
{
	public class HorizontalGroup : Group
	{
		...
		public HorizontalGroup(float spacing) : this() => SetSpacing(spacing);
		...
		{
			float groupHeight = height - _padTop - _padBottom;
			float x = !_reverse ? _padLeft : width - _padRight + _spacing;
