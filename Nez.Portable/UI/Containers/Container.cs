...
namespace Nez.UI
{
	...
	public class Container : Group
	{
		...
		public Container(Element element) : this() => SetElement(element);
		...
		public Container SetBackground(IDrawable background) => SetBackground(background, true);
		...
		/// </summary>
		/// <returns>The element.</returns>
		public T GetElement<T>() where T : Element => _element as T;
		...
		public float GetMinWidth() => _minWidthValue.Get(_element) + _padLeft.Get(this) + _padRight.Get(this);


		public Value GetMinHeightValue() => _minHeightValue;


		public float GetMinHeight() => _minHeightValue.Get(_element) + _padTop.Get(this) + _padBottom.Get(this);


		public Value GetPrefWidthValue() => _prefWidthValue;
		...
		public Value GetPrefHeightValue() => _prefHeightValue;
		...
		public Value GetMaxWidthValue() => _maxWidthValue;
		...
		public Value GetMaxHeightValue() => _maxHeightValue;
