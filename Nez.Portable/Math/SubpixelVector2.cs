...
{
    private SubpixelFloat _x;
    private SubpixelFloat _y;

    /// <summary>
    ///     increments s/y remainders by amount, truncates the values to an int, stores off the new remainders and sets amount
