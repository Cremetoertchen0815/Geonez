...
namespace Nez
{
	public static class Random
	{
		...
		public static float NextFloat(float max) => (float)RNG.NextDouble() * max;
		...
		public static float NextAngle() => (float)RNG.NextDouble() * MathHelper.TwoPi;
		...
		/// <param name="max"></param>
		/// <returns></returns>
		public static Vector2 Range(Vector2 min, Vector2 max) => min + new Vector2(NextFloat(max.X - min.X), NextFloat(max.Y - min.Y));
		...
		public static float MinusOneToOne() => NextFloat(2f) - 1f;
		...
		public static bool Chance(float percent) => NextFloat() < percent;
		...
		public static bool Chance(int value) => NextInt(100) < value;
