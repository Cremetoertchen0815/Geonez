...
namespace Nez
{
	...
	public static class Flags
	{
		...
		public static bool IsFlagSet(this int self, int flag) => (self & flag) != 0;
		...
		/// <param name="self">Self.</param>
		/// <param name="flag">Flag.</param>
		public static void SetFlagExclusive(ref int self, int flag) => self = 1 << flag;
		...
		/// <param name="self">Self.</param>
		/// <param name="flag">Flag.</param>
		public static void SetFlag(ref int self, int flag) => self = (self | 1 << flag);
		...
		/// </summary>
		/// <param name="self">Self.</param>
		public static void InvertFlags(ref int self) => self = ~self;
		...
		public static string BinaryStringRepresentation(this int self, int leftPadWidth = 10) => Convert.ToString(self, 2).PadLeft(leftPadWidth, '0');
	}
}