...
namespace Nez
{
	public static class Insist
	{
		...
		[Conditional("TRACE")]
		[DebuggerHidden]
		public static void IsNull(object obj) => IsTrue(obj == null);
		...
		[Conditional("TRACE")]
		[DebuggerHidden]
		public static void IsNull(object obj, string message, params object[] args) => IsTrue(obj == null, message, args);
		...
		[Conditional("TRACE")]
		[DebuggerHidden]
		public static void IsNotNull(object obj) => IsTrue(obj != null);
		...
		[Conditional("TRACE")]
		[DebuggerHidden]
		public static void IsNotNull(object obj, string message, params object[] args) => IsTrue(obj != null, message, args);
