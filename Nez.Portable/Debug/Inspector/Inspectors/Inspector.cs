...
namespace Nez
{
	...
	public abstract class Inspector
	{
		...
		public static List<Inspector> GetTransformProperties(object transform)
		{
			...
			string[] allowedProps = new string[] { "LocalPosition", "LocalRotationDegrees", "LocalScale" };
		...
		public void SetStructTarget(object target, Inspector parentInspector, FieldInfo field)
		{
			...
			_getter = () =>
			{
				object structValue = parentInspector.GetValue();
		...
		protected T GetValue<T>() => (T)_getter.Invoke();


		protected object GetValue() => _getter.Invoke();


		protected void SetValue(object value) => _setter.Invoke(value);
