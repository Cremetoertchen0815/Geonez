...
namespace Nez
{
	public class RuntimeInspector : IDisposable
	{
		...
		private List<InspectorList> _inspectors = new List<InspectorList>();
		...
		/// </summary>
		public RuntimeInspector() => Initialize();
		...
		private void OnGraphicsDeviceReset() => _scrollPane.SetHeight(Screen.BackbufferHeight);
		...
		public void Update()
		{
			...
			if (_entity != null)
			{
                ...
                for (int i = 0; i < _entity._additionalInspectables.Count; i++)
