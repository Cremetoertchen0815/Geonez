...
namespace Nez
{
	...
	/// Inspectors are only active in TRACE builds so make sure to wrap your custom inspector subclass in #if TRACE/#endif.
	/// </summary>
	...
	public class CustomInspectorAttribute : Attribute
	{
		...
		public CustomInspectorAttribute(Type inspectorType) => InspectorType = inspectorType;
	}
}