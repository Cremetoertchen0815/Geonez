...
namespace Nez
{
	...
	public class VirtualJoystick : VirtualInput
	{
		...
		public Vector2 Value
		{
			get
			{
				if (!Input.IsInputActive(this)) return Vector2.Zero;
		...
		public VirtualJoystick(bool normalized) : base() => Normalized = normalized;
		...
		{
			if (!Input.IsInputActive(joystick)) return Vector2.Zero;
		...
		public class GamePadDpad : Node
		{
			...
			public GamePadDpad(int gamepadIndex = 0) => GamepadIndex = gamepadIndex;
