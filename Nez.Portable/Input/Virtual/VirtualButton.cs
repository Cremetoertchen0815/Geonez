...
namespace Nez
{
	...
	public class VirtualButton : VirtualInput
	{
		...
		public bool IsDown
		{
			get
			{
				if (!Input.IsInputActive(this)) return false;
		...
		public bool IsPressed
		{
			get
			{
				...
				if (_bufferCounter > 0 || IsRepeating)
					return Time.FirstUpdateInFrame;
		...
		public bool IsReleased
		{
			get
			{
				if (!Input.IsInputActive(this)) return true;
		...
		public void ConsumeBuffer() => _bufferCounter = 0;
		...
		public static implicit operator bool(VirtualButton button) => button.IsDown;
		...
		public class GamePadDPadRight : Node
		{
			...
			public GamePadDPadRight(int gamepadIndex) => GamepadIndex = gamepadIndex;
		...
		public class GamePadDPadLeft : Node
		{
			...
			public GamePadDPadLeft(int gamepadIndex) => GamepadIndex = gamepadIndex;
		...
		public class GamePadDPadUp : Node
		{
			...
			public GamePadDPadUp(int gamepadIndex) => GamepadIndex = gamepadIndex;
		...
		public class GamePadDPadDown : Node
		{
			...
			public GamePadDPadDown(int gamepadIndex) => GamepadIndex = gamepadIndex;
