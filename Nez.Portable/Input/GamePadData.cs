...
public class GamePadData
{
    ...
    public bool DpadUpPressed =>
        _currentState.DPad.Up == ButtonState.Pressed && _previousState.DPad.Up == ButtonState.Released;
    ...
    public bool DpadUpReleased =>
        _currentState.DPad.Up == ButtonState.Released && _previousState.DPad.Up == ButtonState.Pressed;
