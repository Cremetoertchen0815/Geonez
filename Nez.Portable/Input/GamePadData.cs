...
namespace Nez
{
	public class GamePadData
	{
		...
		public bool IsButtonPressed(Buttons button) => _currentState.IsButtonDown(button) && !_previousState.IsButtonDown(button);
		...
		/// <param name="button">Button.</param>
		public bool IsButtonReleased(Buttons button) => !_currentState.IsButtonDown(button) && _previousState.IsButtonDown(button);
		...
		public bool IsLeftStickLeft(float deadzone = Input.DEFAULT_DEADZONE) => _currentState.ThumbSticks.Left.X < -deadzone;
		...
		public bool IsLeftStickLeftPressed(float deadzone = Input.DEFAULT_DEADZONE) => _currentState.ThumbSticks.Left.X < -deadzone && _previousState.ThumbSticks.Left.X > -deadzone;


		public bool IsLeftStickRight(float deadzone = Input.DEFAULT_DEADZONE) => _currentState.ThumbSticks.Left.X > deadzone;
		...
		/// <param name="deadzone">Deadzone.</param>
		public bool IsLeftStickRightPressed(float deadzone = Input.DEFAULT_DEADZONE) => _currentState.ThumbSticks.Left.X > deadzone && _previousState.ThumbSticks.Left.X < deadzone;


		public bool IsLeftStickUp(float deadzone = Input.DEFAULT_DEADZONE) => _currentState.ThumbSticks.Left.Y > deadzone;
		...
		/// <param name="deadzone">Deadzone.</param>
		public bool IsLeftStickUpPressed(float deadzone = Input.DEFAULT_DEADZONE) => _currentState.ThumbSticks.Left.Y > deadzone && _previousState.ThumbSticks.Left.Y < deadzone;


		public bool IsLeftStickDown(float deadzone = Input.DEFAULT_DEADZONE) => _currentState.ThumbSticks.Left.Y < -deadzone;
		...
		/// <param name="deadzone">Deadzone.</param>
		public bool IsLeftStickDownPressed(float deadzone = Input.DEFAULT_DEADZONE) => _currentState.ThumbSticks.Left.Y < -deadzone && _previousState.ThumbSticks.Left.Y > -deadzone;


		public bool IsRightStickLeft(float deadzone = Input.DEFAULT_DEADZONE) => _currentState.ThumbSticks.Right.X < -deadzone;


		public bool IsRightStickRight(float deadzone = Input.DEFAULT_DEADZONE) => _currentState.ThumbSticks.Right.X > deadzone;


		public bool IsRightStickUp(float deadzone = Input.DEFAULT_DEADZONE) => _currentState.ThumbSticks.Right.Y > deadzone;


		public bool IsRightStickDown(float deadzone = Input.DEFAULT_DEADZONE) => _currentState.ThumbSticks.Right.Y < -deadzone;
		...
		public float GetLeftTriggerRaw() => _currentState.Triggers.Left;


		public float GetRightTriggerRaw() => _currentState.Triggers.Right;
		...
		public bool IsLeftTriggerDown(float threshold = 0.2f) => _currentState.Triggers.Left > threshold;
		...
		/// <param name="threshold">Threshold.</param>
		public bool IsLeftTriggerPressed(float threshold = 0.2f) => _currentState.Triggers.Left > threshold && _previousState.Triggers.Left < threshold;
		...
		/// <param name="threshold">Threshold.</param>
		public bool IsLeftTriggerReleased(float threshold = 0.2f) => _currentState.Triggers.Left < threshold && _previousState.Triggers.Left > threshold;
		...
		/// <returns><c>true</c>, if left trigger down was ised, <c>false</c> otherwise.</returns>
		/// <param name="threshold">Threshold.</param>
		public bool IsRightTriggerDown(float threshold = 0.2f) => _currentState.Triggers.Right > threshold;
		...
		/// <returns><c>true</c>, if left trigger pressed was ised, <c>false</c> otherwise.</returns>
		/// <param name="threshold">Threshold.</param>
		public bool IsRightTriggerPressed(float threshold = 0.2f) => _currentState.Triggers.Right > threshold && _previousState.Triggers.Right < threshold;
		...
		/// <returns><c>true</c>, if left trigger released was ised, <c>false</c> otherwise.</returns>
		/// <param name="threshold">Threshold.</param>
		public bool IsRightTriggerReleased(float threshold = 0.2f) => _currentState.Triggers.Right < threshold && _previousState.Triggers.Right > threshold;
