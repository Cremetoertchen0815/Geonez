...
namespace Nez
{
	...
	public class Transform : IVariableUpdatable
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public Transform SetPosition(float x, float y) => SetPosition(new Vector2(x, y));
		...
		/// <param name="radians">Radians.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public Transform SetRotationDegrees(float degrees) => SetRotation(MathHelper.ToRadians(degrees));
		...
		/// <param name="radians">Radians.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public Transform SetLocalRotationDegrees(float degrees) => SetLocalRotation(MathHelper.ToRadians(degrees));
		...
		/// <param name="scale">Scale.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public Transform SetScale(float scale) => SetScale(new Vector2(scale));
		...
		/// <param name="scale">Scale.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public Transform SetLocalScale(float scale) => SetLocalScale(new Vector2(scale));
		...
		/// </summary>
		public void RoundPosition() => Position = Vector2Ext.Round(_position);
