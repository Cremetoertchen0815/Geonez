...
public class Entity : IComparable<Entity>
{
    ...
    internal int _updateOrder;

    /// <summary>
    ///     Internal dictionary of attached data.
    /// </summary>
    private Dictionary<string, object> _internalData;
    ...
    public void SetInternalData(ref string key, object value)
    {
        ...
        if (_internalData == null) _internalData = new Dictionary<string, object>();
    ...
    public object GetInternalData(ref string key)
    {
        ...
        if (_internalData == null) return null;
    ...
    {
        return Components.GetComponent<T>(name, false);
    }
    ...
    {
        return Components.GetComponents<T>(name);
    }
