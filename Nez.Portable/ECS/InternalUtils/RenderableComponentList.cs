...
public class RenderableComponentList
{
    ...
    /// </summary>
    private readonly FastList<IRenderable> _components = new();
    ...
    private void AddToRenderLayerList(IRenderable component, int renderLayer)
    {
        ...
        Insist.IsFalse(
            list.Contains(component) && (!(component is Component) || !(component as Component).isGettingRemoved),
            "Component renderLayer list already contains this component");
