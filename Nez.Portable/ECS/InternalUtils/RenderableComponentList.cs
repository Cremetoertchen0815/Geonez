...
namespace Nez
{
	public class RenderableComponentList
	{
		...
		private void AddToRenderLayerList(IRenderable component, int renderLayer)
		{
			...
			Insist.IsFalse(list.Contains(component) && (!(component is Component) || !(component as Component).isGettingRemoved), "Component renderLayer list already contains this component");
