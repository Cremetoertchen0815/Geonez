...
namespace Nez
{
	...
	public class ArcadeRigidbody : Component, IUpdatable
	{
		...
		public ArcadeRigidbody() => _inverseMass = 1 / _mass;
		...
		private void ProcessCollision(ArcadeRigidbody other, ref Vector2 minimumTranslationVector)
		{
			...
			float totalInverseMass = _inverseMass + other._inverseMass;
			float ourResponseFraction = _inverseMass / totalInverseMass;
			float otherResponseFraction = other._inverseMass / totalInverseMass;
									   ...
									   out Vector2 responseVelocity)
		{
			...
			float coefficientOfFriction = _friction;
