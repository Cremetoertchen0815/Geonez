...
namespace Nez
{
	public class CircleCollider : Collider
	{
		...
		public CircleCollider(float radius) => Shape = new Circle(radius);
		...
		public override string ToString() => string.Format("[CircleCollider: bounds: {0}, radius: {1}", Bounds, ((Circle)Shape).Radius);
	}
}