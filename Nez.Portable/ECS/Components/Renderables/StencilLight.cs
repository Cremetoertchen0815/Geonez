...
/// <summary>
///     Light that works with the StencilLightRenderer. This uses a texture-less shader with a simple falloff calculation
///     to draw a light.
/// </summary>
public class StencilLight : RenderableComponent
{
    private StencilLightEffect _lightEffect;
    ...
    public override RectangleF Bounds
    {
        get
        {
            if (_areBoundsDirty)
            {
                ...
                _bounds.CalculateBounds(Entity.Transform.Position, _localOffset,
                    new Vector2(_radius * scale, _radius * scale),
