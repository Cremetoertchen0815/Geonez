...
namespace Nez.Shadows
{
	...
	internal class EndPoint
	{
		...
		public override int GetHashCode() => position.GetHashCode() + begin.GetHashCode() + angle.GetHashCode();


		public override string ToString() => "{ p:" + position.ToString() + "a: " + angle + " in " + segment.ToString() + "}";
	}
