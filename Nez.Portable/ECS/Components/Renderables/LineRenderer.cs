...
{
    private readonly FastList<short> _indices = new(50);
    private readonly Segment _lastSegment = new();
    private readonly FastList<SegmentPoint> _points = new();
    private readonly FastList<VertexPositionColorTexture> _vertices = new(50);
    ...
    private Segment _firstSegment = new();
    private float _maxWidth = 10;
    private Segment _secondSegment = new();
