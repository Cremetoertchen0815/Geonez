	...
	public class Model3D : Renderable3D
	{
		public override RectangleF Bounds
		{
			get
			{
				...
				float sizeX = sphere.Radius * 2 * Scale.X;
				float sizeY = sphere.Radius * 2 * Scale.Y;
				float x = (Position.X + sphere.Center.X - sizeX / 2);
				float y = (Position.Y + sphere.Center.Y - sizeY / 2);
