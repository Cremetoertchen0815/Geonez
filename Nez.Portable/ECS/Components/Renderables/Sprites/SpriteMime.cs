namespace Nez.Sprites
{
	...
	public class SpriteMime : RenderableComponent
	{
		...
		private SpriteRenderer _spriteToMime;


		public SpriteMime() => Enabled = false;

		public SpriteMime(SpriteRenderer spriteToMime) => _spriteToMime = spriteToMime;
		...
		public override void Render(Batcher batcher, Camera camera) => batcher.Draw(_spriteToMime.Sprite, Entity.Transform.Position + _localOffset, Color,
