...
namespace Nez.AI.GOAP
{
	public class Action
	{
		...
		public Action(string name, int cost) : this(name) => Cost = cost;


		public void SetPrecondition(string conditionName, bool value) => _preConditions.Add(new Tuple<string, bool>(conditionName, value));


		public void SetPostcondition(string conditionName, bool value) => _postConditions.Add(new Tuple<string, bool>(conditionName, value));
		...
		public override string ToString() => string.Format("[Action] {0} - cost: {1}", Name, Cost);
	}
}