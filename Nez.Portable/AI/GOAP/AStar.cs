...
namespace Nez.AI.GOAP
{
	public class AStarNode : IComparable<AStarNode>, IEquatable<AStarNode>, IPoolable
	{
		...
		public int CompareTo(AStarNode other) => CostSoFarAndHeuristicCost.CompareTo(other.CostSoFarAndHeuristicCost);
		...
		public AStarNode Clone() => (AStarNode)MemberwiseClone();


		public override string ToString() => string.Format("[cost: {0} | heuristic: {1}]: {2}", CostSoFar, HeuristicCost, Action);
	}
