...
/// </summary>
[ContentProcessor(DisplayName = "Binary Effect Processor")]
public class BinaryEffectsProcessor : ContentProcessor<EffectContent, ProcessedBinaryData>
{
    private EffectProcessorDebugMode debugMode;
    ...
    /// <summary>
    ///     Processes the string representation of the specified effect into a platform-specific binary format using the
    ///     specified context.
    /// </summary>
    ...
    /// <remarks>
    ///     If you get an error during processing, compilation stops immediately. The effect processor displays an error
    ///     message. Once you fix the current error, it is possible you may get more errors on subsequent compilation attempts.
    /// </remarks>
    public override ProcessedBinaryData Process(EffectContent input, ContentProcessorContext context)
    {
        ...
        var ret = success ? new ProcessedBinaryData { Data = File.ReadAllBytes(destFile), Compressed = false } : null;
    ...
    private static void ProcessErrorsAndWarnings(bool buildFailed, string shaderErrorsAndWarnings, EffectContent input,
