...
public static class Extensions
{
	...
	public static Animations GetAnimations(this Model model, bool cloned)
    {
        ...
        if (animations == null)
            throw new Exception(
                "No animations data found on model. Make sure the model processor is set to an animated model in the content manager.");
	...
	public static void UpdateVertices(this ModelMeshPart meshPart, Matrix[] boneTransforms)
    {
        ...
        if (animatedVertexBuffer == null)
            throw new Exception(
                "Cannot find CPU-animated data. Make sure the model processor is set to CPU-animated model in the content manager.");
