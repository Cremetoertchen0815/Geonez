...
{
	/// <summary>
	///     Frame width, in percents relative to texture size (eg if texture width is 100 and frame width is 0.1, final
	///     frame width would be 10 pixels)
	/// </summary>
	public float FrameWidth;

	/// <summary>
	///     Frame height, in percents relative to texture size (eg if texture height is 100 and frame height is 0.1, final
	///     frame height would be 10 pixels)
	/// </summary>
