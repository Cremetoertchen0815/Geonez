...
public static class ToBullet
{
    ...
    public static Vector3 Vector(Microsoft.Xna.Framework.Vector3 vec)
    {
    ...
    public static Vector3[] Vectors(Microsoft.Xna.Framework.Vector3[] vecs)
    {
        var bvectors = new Vector3[vecs.Length];
        var i = 0;
        foreach (var vector in vecs) bvectors[i++] = Vector(vector);
        return bvectors;
    }
    ...
    public static Matrix Matrix(Microsoft.Xna.Framework.Matrix matrix)
    {
        return new Matrix(
...
public static class ToMonoGame
{
    ...
    public static Microsoft.Xna.Framework.Vector3[] Vectors(Vector3[] bvecs)
    {
        var vectors = new Microsoft.Xna.Framework.Vector3[bvecs.Length];
        var i = 0;
        foreach (var bvector in bvecs) vectors[i++] = Vector(bvector);
        return vectors;
    }
