...
public class RigidBody : BasicPhysicalBody
{
    ...
    /// </summary>
    internal override CollisionObject _BulletEntity => BulletRigidBody;

    /// <summary>
    ///     Get the rigid body in bullet format.
    /// </summary>
    internal BulletSharp.RigidBody BulletRigidBody { get; }
    ...
    public void ClearForces(bool clearVelocity = true)
    {
        ...
        if (clearVelocity) ClearVelocity();
    }
    ...
    internal override void AddSelfToBulletWorld(DynamicsWorld world)
    {
        ...
        if (HasCustomGravity) Gravity = Gravity;
    }
