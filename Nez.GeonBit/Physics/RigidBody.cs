...
namespace Nez.GeonBit.Physics
{
    ...
    public class RigidBody : BasicPhysicalBody
    {
        ...
        public void SetDamping(double linear, double angular) => BulletRigidBody.SetDamping(linear, angular);
        ...
        public void SetMassAndInertia(double mass, double inertia) => BulletRigidBody.SetMassProps(mass, _shape.BulletCollisionShape.CalculateLocalInertia(mass) * inertia);
        ...
        public RigidBody(CollisionShapes.ICollisionShape shape, double mass = 10f, double inertia = 1f, Matrix? transformations = null)
        {
