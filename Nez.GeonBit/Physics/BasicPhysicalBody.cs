...
public class BasicPhysicalBody
{
    ...
    /// </summary>
    protected ICollisionShape _shape;
    ...
    /// </summary>
    internal virtual CollisionObject _BulletEntity { get; }

    /// <summary>
    ///     Get the collision shape.
    /// </summary>
    public ICollisionShape Shape => _shape;
    ...
    /// <summary>
    ///     If true, this object will not have a physical body (eg other objects will pass through it), but will still trigger
    ///     contact events.
    /// </summary>
    ...
    internal virtual void AddSelfToBulletWorld(DynamicsWorld world)
    {
    }
    ...
    internal virtual void RemoveSelfFromBulletWorld(DynamicsWorld world)
    {
    }
}