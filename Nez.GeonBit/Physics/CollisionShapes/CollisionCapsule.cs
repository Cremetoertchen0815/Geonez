...
{
    // cylinder axis type
    private readonly CapsuleDirectionAxis _axisType;
    ...
    public CollisionCapsule(double radius = 1f, double height = 1f, CapsuleDirectionAxis axis = CapsuleDirectionAxis.Y)
    {
        ...
        switch (_axisType)
        {
            case CapsuleDirectionAxis.X:
                _shape = new CapsuleShapeX(radius, height);
                break;
            ...
            case CapsuleDirectionAxis.Z:
                _shape = new CapsuleShapeZ(radius, height);
                break;
        }
    }
    ...
    {
        var shape = _shape as CapsuleShape;
