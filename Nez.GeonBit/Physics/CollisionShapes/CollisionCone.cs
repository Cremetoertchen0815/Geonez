...
{
    // cylinder axis type
    private readonly ConeDirectionAxis _axisType;
    ...
    public CollisionCone(float radius = 1f, float height = 1f, ConeDirectionAxis axis = ConeDirectionAxis.Y)
    {
        ...
        switch (_axisType)
        {
            case ConeDirectionAxis.X:
                _shape = new ConeShapeX(radius, height);
                break;

            case ConeDirectionAxis.Y:
                _shape = new ConeShape(radius, height);
                break;

            case ConeDirectionAxis.Z:
                _shape = new ConeShapeZ(radius, height);
                break;
        }
    }
