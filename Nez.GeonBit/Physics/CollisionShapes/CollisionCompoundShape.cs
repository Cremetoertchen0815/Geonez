...
public class CollisionCompoundShape : ICollisionShape
{
    ...
    public void Clear()
    {
        ...
        var shape = _shape as CompoundShape;
        foreach (var child in shape.ChildList) shape.RemoveChildShape(child.ChildShape);
    }
    ...
    {
        var comShape = _shape as CompoundShape;
    ...
    protected override ICollisionShape CloneImp()
    {
        ...
        foreach (var child in shape.ChildList)
        {
            ...
            ((CompoundShape)ret._shape).AddChildShape(transform, collShape);
        }
