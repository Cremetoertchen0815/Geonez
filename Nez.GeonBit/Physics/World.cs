...
namespace Nez.GeonBit.Physics
{
    ...
    public class PhysicsWorld : SceneComponent
    {
        ...
        private readonly BulletSharp.CollisionConfiguration _config;
        private readonly BulletSharp.BroadphaseInterface _broadphase;
        private readonly BulletSharp.ConstraintSolver _solver;
        private readonly BulletSharp.Dispatcher _dispatcher;
