...
namespace Nez.GeonBit
{
    ...
    internal class OctreeCullingNode : Node
    {
        ...
        private readonly List<Node> _nodesUnderThisOctreeBox = new List<Node>();
        ...
        /// </summary>
        private readonly uint _divisionsLeft = 0;
        ...
        /// </summary>
        /// <param name="boundingBox">The starting bounding box of the entire octree. GeonNode: nodes that are outside this box will not be culled properly.</param>
