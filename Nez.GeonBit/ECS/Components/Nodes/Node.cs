...
namespace Nez.GeonBit
{
	...
	public class Node
	{
		...
		public void AddEntity(IEntity entity)
		{
			...
			if (!CanHoldEntities)
			{
				throw new System.InvalidOperationException("Cannot add entities to this node type.");
			}
		...
		public Node AddChildNode(Node node)
		{
			...
			if (node.Parent != null)
			{
				throw new System.InvalidOperationException("Can't add a node that already have a parent.");
			}
		...
		public void RemoveChildNode(Node node)
		{
			...
			if (node.Parent != this)
			{
				throw new System.InvalidOperationException("Can't remove a node that don't belong to this parent.");
			}
		...
		public void RemoveFromParent()
		{
			...
			if (Parent == null)
			{
				throw new System.InvalidOperationException("Can't remove an orphan node from parent.");
			}
