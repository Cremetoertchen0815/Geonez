...
public class ModelRenderer : BaseRendererWithOverrideMaterial
{
    ...
    {
        _entity = new ModelEntity(GeonDefaultRenderer.CurrentContentManager.LoadModel(model,
            x => DefaultMaterialsFactory.GetDefaultMaterial(x)));
    }
