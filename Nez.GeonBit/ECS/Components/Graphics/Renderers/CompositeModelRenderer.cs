...
///     Its slightly slower than SimpleModelRenderer and ModelRenderer, but provide more control and better
///     distance-from-camera sorting for transparency.
/// </summary>
public class CompositeModelRenderer : BaseRendererComponent
{
    ...
    {
        _entity = new CompositeModelEntity(model);
    }
    ...
    public override RenderingQueue RenderingQueue
    {
        set
        {
            foreach (var mesh in GetMeshes()) mesh.RenderingQueue = value;
        }
    }
    ...
    public override Component Clone()
    {
        ...
        CopyBasics(ret);
        for (var i = 0; i < _entity.MeshesCount; ++i)
        {
