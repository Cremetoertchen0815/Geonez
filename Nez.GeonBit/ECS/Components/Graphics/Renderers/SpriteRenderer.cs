...
public class SpriteRenderer : BaseRendererWithOverrideMaterial, IUpdatable
{
    ...
    ///     This optimization reduce load/unload time and memory, but it means the material is shared with other sprites.
    /// </param>
    ...
    public void Update()
    {
        _entity.Update(Time.DeltaTime * AnimationSpeed);
    }
