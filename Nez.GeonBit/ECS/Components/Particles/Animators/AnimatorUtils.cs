...
public static class AnimatorUtils
{
    ...
    {
        var originalLen = baseVector.Length();
    ...
    /// </summary>
    public static Vector3 RandVector(Vector3 minVector, Vector3 maxVector)
    {
        return new Vector3(
    ...
    /// </summary>
    public static Vector3 RandVector(Vector3 maxVector)
    {
        return new Vector3(
    ...
    /// </summary>
    public static Color RandColor(Color baseColor, Color colorJitter)
    {
        return new Color(
    ...
    /// </summary>
    public static Color RandColor2(Color minColor, Color maxColor)
    {
        return new Color(
