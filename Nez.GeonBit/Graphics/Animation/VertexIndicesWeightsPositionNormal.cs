...
public struct VertexIndicesWeightsPositionNormal : IVertexType
{
    ...
    public VertexIndicesWeightsPositionNormal(Vector3 position, Vector3 normal, Vector4 blendWeights, byte blendIndex0,
        byte blendIndex1, byte blendIndex2, byte blendIndex3)
    {
    ...
    {
        return string.Format("{{Position:{0} Normal:{1} BlendWeights:{2} BlendIndices:{3},{4},{5},{6} }}", Position,
            Normal, BlendWeights, BlendIndex0, BlendIndex1, BlendIndex2, BlendIndex3);
    }
}