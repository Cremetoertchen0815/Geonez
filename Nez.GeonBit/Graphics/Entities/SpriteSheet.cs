...
namespace Nez.GeonBit
{
    ...
    public class SpriteSheet
    {
        ...
        private readonly List<SpriteSheetStep> _steps = new List<SpriteSheetStep>();

        // dictionary of step names (to get sprite from spritesheet via string identifier)
        private readonly Dictionary<string, int> _stepsIdentifierToIndex = new Dictionary<string, int>();
    ...
    public class SpriteAnimationClip
    {
        ...
        private readonly Dictionary<int, float> _perStepDelays = new Dictionary<int, float>();
