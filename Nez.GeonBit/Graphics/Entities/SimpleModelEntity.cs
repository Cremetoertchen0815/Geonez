...
/// <summary>
///     A basic renderable model with minimum control over materials and meshes, but with best performance compared to
///     other
...
public class SimpleModelEntity : BaseRenderableEntity, IShadowCaster
{
    ...
    protected void PrepareMaterial(MaterialAPI material, Matrix world)
    {
