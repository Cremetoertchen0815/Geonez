...
public struct VertexPositionNormalTangentTexture : IVertexType
{
    ...
    public VertexPositionNormalTangentTexture(Vector3 position, Vector3 normal, Vector2 textureCoordinate,
    ...
    public static bool operator ==(VertexPositionNormalTangentTexture left, VertexPositionNormalTangentTexture right)
    {
        return left.Position == right.Position && left.Normal == right.Normal &&
               left.TextureCoordinate == right.TextureCoordinate && left.Binormal == right.Binormal &&
