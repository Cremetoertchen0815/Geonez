...
namespace Nez.GeonBit.Graphics.Materials
{
    public class RefractiveMaterial : MaterialAPI
    {
        ...
        public virtual Effect CreateEffect() => Core.Content.Load<Effect>(_effectPath.ToString().ToLower()).Clone();
        ...
        public override MaterialAPI Clone() => new RefractiveMaterial(this);
