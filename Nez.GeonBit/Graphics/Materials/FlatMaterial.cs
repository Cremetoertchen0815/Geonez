...
namespace Nez.GeonBit.Materials
{
    public class FlatMaterial : MaterialAPI
    {
        ...
        private static readonly BasicEffect _emptyEffect = new BasicEffect(Core.GraphicsDevice);

        /// <summary>
        /// Create the default material from empty effect.
        /// </summary>
        public FlatMaterial() : this(_emptyEffect, true)
        {
        }
        ...
        public override MaterialAPI Clone() => new FlatMaterial(this);
    }
}
