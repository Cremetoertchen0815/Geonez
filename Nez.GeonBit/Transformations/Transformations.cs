	...
	public class Transformations
	{
		...
		public Matrix BuildRotationMatrix()
		{
			...
			if (RotationType == RotationType.Euler)
			{
				switch (RotationOrder)
				{
					...
					default:
						throw new System.ArgumentOutOfRangeException("Unknown rotation order!");
				}
			}
			...
			{
				throw new System.ArgumentOutOfRangeException("Unknown rotation type!");
			}
		}
		...
		public Matrix BuildMatrix()
		{
			...
			switch (TransformOrder)
			{
				...
				default:
					throw new System.ArgumentOutOfRangeException("Unknown build matrix order!");
			}
		}
	}
}
