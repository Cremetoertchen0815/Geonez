...
public class Transformations
{
    ...
    public Matrix BuildRotationMatrix()
    {
        ...
        if (RotationType == RotationType.Euler)
            switch (RotationOrder)
            {
                ...
                case RotationOrder.RotateXZY:
                    return Matrix.CreateRotationX(Rotation.X) * Matrix.CreateRotationZ(Rotation.Z) *
                ...
                case RotationOrder.RotateYZX:
                    return Matrix.CreateRotationY(Rotation.Y) * Matrix.CreateRotationZ(Rotation.Z) *
                           Matrix.CreateRotationX(Rotation.X);

                case RotationOrder.RotateZXY:
                    return Matrix.CreateRotationZ(Rotation.Z) * Matrix.CreateRotationX(Rotation.X) *
                           Matrix.CreateRotationY(Rotation.Y);

                case RotationOrder.RotateZYX:
                    return Matrix.CreateRotationZ(Rotation.Z) * Matrix.CreateRotationY(Rotation.Y) *
                           Matrix.CreateRotationX(Rotation.X);
        ...
        if (RotationType == RotationType.Quaternion)
        {
            ...
            {
                case RotationOrder.RotateXYZ:
                    quat = Quaternion.CreateFromAxisAngle(Vector3.UnitX, Rotation.X) *
                ...
                case RotationOrder.RotateYZX:
                    quat = Quaternion.CreateFromAxisAngle(Vector3.UnitY, Rotation.Y) *
                           Quaternion.CreateFromAxisAngle(Vector3.UnitZ, Rotation.Z) *
                           Quaternion.CreateFromAxisAngle(Vector3.UnitX, Rotation.X);
                    break;

                case RotationOrder.RotateZXY:
                    quat = Quaternion.CreateFromAxisAngle(Vector3.UnitZ, Rotation.Z) *
                           Quaternion.CreateFromAxisAngle(Vector3.UnitX, Rotation.X) *
                           Quaternion.CreateFromAxisAngle(Vector3.UnitY, Rotation.Y);
                    break;
