...
namespace Nez.GeonBit.UI.Entities
{
	...
	public class Paragraph : Entity
	{
		...
		/// Static ctor.
		/// </summary>
		static Paragraph() => Entity.MakeSerializable(typeof(Paragraph));
		...
		{
			get => _text;
			set { var txt = TextModifier(value); if(_text != txt) { _text = txt; MarkAsDirty(); } }
		}
		...
		public SpriteFont GetCurrFont() => FontOverride ?? Resources.Fonts[(int)TextStyle];
