...
public class MulticolorSelectList : PanelBase
{
    ...
    private List<MulticolorParagraph> _paragraphs = new();
    ...
    public MulticolorSelectList(Vector2 size, Anchor anchor = Anchor.Auto, Vector2? offset = null,
    ...
    // list of values
    private List<string> _list { get; set; } = new();
