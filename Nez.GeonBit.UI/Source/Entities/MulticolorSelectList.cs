...
namespace Nez.GeonBit.UI.Entities
{
	...
	public struct MulticolorParagraphData
	{
		public MulticolorSelectList list;
		public int relativeIndex;
		public MulticolorParagraphData(MulticolorSelectList _list, int _relativeIndex)
		{
			list = _list;
	...
	/// </summary>
	[System.Serializable]
	public class MulticolorSelectList : PanelBase
	{
		/// <summary>
		/// Static ctor.
		/// </summary>
		static MulticolorSelectList() => Entity.MakeSerializable(typeof(SelectList));
		...
		private List<MulticolorParagraph> _paragraphs = new List<MulticolorParagraph>();
		...
		/// </summary>
		public string AddWhenClipping { get; set; } = "..";
		...
		public MulticolorSelectList(Vector2 size, Anchor anchor = Anchor.Auto, Vector2? offset = null, PanelSkin skin = PanelSkin.ListBackground) :
		...
		/// <param name="anchor">Position anchor.</param>
		/// <param name="offset">Offset from anchor position.</param>
		public MulticolorSelectList(Anchor anchor, Vector2? offset = null) :
		...
		/// </summary>
		public MulticolorSelectList() : this(Anchor.Auto)
		{
		}
		...
		protected virtual void OnResize()
		{
			...
			while (true)
			{
				...
				var paragraph = (MulticolorParagraph)UserInterface.DefaultParagraph(".", Anchor.Auto);
				...
				paragraph.AttachedData = new MulticolorParagraphData(this, i++);
				...
				{
					var data = (MulticolorParagraphData)entity.AttachedData;
